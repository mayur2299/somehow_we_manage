...
const { ward, pinInfo, wardSlug } = defineProps<{ ward: any; pinInfo: { pin: string; area: string }; wardSlug: string }>()
...
<template>
  <div>
      ...
      <nav>
        ...
        <button class="btn sm" @click="emit('changePin')">📍 {{ pinInfo.pin }} · change</button>
      </nav>
